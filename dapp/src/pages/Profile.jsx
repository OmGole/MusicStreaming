...
const Profile = () => {
  ...
  const handleMint = async (e) => {
    ...
    const tokenId = await contract.createToken(ethPrice, metadataResponse.pinataURL);
    console.log(tokenId);
    setName("");
    setDescription("");
        ...
        <div className="bg-form shadow-2xl rounded-xl w-1/2 mx-auto p-8">
          ...
          <form action="" className="px-3">
            ...
            <div className="mb-5">
              ...
              <input type="text" name="genre" id="genre" className="ml-12" value={genre} onChange={(e) => setGenre(e.target.value)}/>
            </div>
            <div className="mb-5">
              <label htmlFor="price" className="font-semibold">
                Price
              </label>
              <input type="number" name="price" id="price" className="ml-14" value={price} onChange={(e) => setPrice(e.target.value)}/>
            </div>
            <div className="mb-5">
              <label for="myfile" className="font-semibold">
                Upload Image:
              </label>
              <input type="file" id="myfile" name="myfile" onChange={handleImage}></input>
            </div>
            <div className="mb-5">
              <label for="myfile" className="font-semibold">
                Upload Audio:
              </label>
              <input type="file" id="myfile" name="myfile" onChange={handleAudio}></input>
            </div>
            <button
              type="submit"
